...
function gen_world(world_n, list_chunks_large, list_chunks_medium, list_chunks_small) {
	var world_width = 41,
	world_height = 41;
	...
	switch(world_n) {
		...
		#region Chunks
			...
			chunk_create(8,irandom(4),15,14);
		
			//Medium Chunks
			chunk_create(10,irandom(2),13,1);
		
			//Large Chunks
			chunk_create(12,irandom(2),1,12);
		#endregion
		...
		#region Enemy Spawn/Path
			...
			ds_grid_set(enemy0,0,16,obj_mad_man);
			ds_grid_set(enemy0,18,18,obj_bandit);
			ds_grid_set(enemy0,27,13,obj_bandit);
			ds_grid_set(enemy0,28,15,obj_bandit);
			ds_grid_set(enemy0,39,18,obj_mad_man);
			ds_grid_set(enemy0,22,20,obj_savage);
			ds_grid_set(enemy0,1,30,obj_savage);
			ds_grid_set(enemy0,8,30,obj_savage);
			ds_grid_set(enemy0,18,28,obj_mad_man);
			ds_grid_set(enemy0,35,37,obj_mad_man);*/
			xx = 19; yy = 3; n = 1;
