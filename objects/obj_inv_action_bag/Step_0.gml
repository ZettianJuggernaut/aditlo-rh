	...
	if(position_meeting(device_mouse_x_to_gui(0),device_mouse_y_to_gui(0),id)) {
		switch(sprite_index) {
			case(spr_inv_action_pickup):
				...
				if(inv_from[# 1,slot_y] < 1) ds_grid_set_region(inv_from,0,slot_y,global.inventory_width,slot_y,0);
			break;
			case(spr_inv_action_pickup_all):
				...
				if(added) ds_grid_set_region(inv_from,0,slot_y,global.inventory_width,slot_y,0);
			break;
		}
